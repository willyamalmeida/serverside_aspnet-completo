...
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 32, 'JONAS', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 33, 'JULIA', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 34, 'JULIANA', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 35, 'JULIANO', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 36, 'JUDITE', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 37, 'JOEL', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 38, 'JAIR', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 39, 'JAIME', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 40, 'JANICE', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 41, 'ABRAAO', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 42, 'ABIGAIL', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 43, 'ADAIR', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 44, 'ADELIA', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 45, 'ADRIANO', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 46, 'AFONSO', @IDDESENVOLVIMENTO);
INSERT INTO FUNCIONARIO (ID, CODIGO, NOME, IDDEPARTAMENTO) VALUES (NEWID(), 47, 'ALCIONE', @IDDESENVOLVIMENTO);